...
> [!Note]
Do not place a space between the link text and the link, otherwise the square brackets show in the rendered content. Example: I will get a good job on [LinkIn](https://www.linkedin.com/).  
